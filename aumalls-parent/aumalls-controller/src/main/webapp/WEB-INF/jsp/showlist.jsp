...
<link rel="stylesheet" href="<%=request.getContextPath()%>/static/css/list.css">
<base target="_blank">
</head>
<body>
<header class="wrap-all">
	...
	<div class="logoAndSearch w1190 textWarp">
		...
		<div class="app">
			...
			<div class="SAEr">
				<p>扫描下载澳猫APP</p>
				<img src="<%=request.getContextPath()%>/static/images/AppEr.png" alt="二维码">
			</div>
		</div>
	</div>
	<!-- 导航 -->
					...
					<div class="HRproduct">
						<ul>
							<li>
								<div class="HRpic">
									<a href="#">
										<img class="lazy" src="js/lazyload/grey.gif" data-original="<%=request.getContextPath()%>/static/images/lproduct7.png" alt="">
									</a>
								</div>
								<div class="HRtxt">
				...
				<div class="product">
					<ul class="clearfix">
						<li>
							...
							<div class="proImg">
								<a href="#">
									<img class="lazy" src="js/lazyload/grey.gif" data-original="<%=request.getContextPath()%>/static/images/product2L.jpg" alt="">
								</a>
							</div>
							<div class="proTxt">
	...
	<div class="foot">
		...
		<div class="information center_1200 textWarp">
			...
			<div class="Ileft">
				<div class="er">
					<div class="erPic">
						<img src="<%=request.getContextPath()%>/static/images/WXe.png" alt="二维码">
					</div>
					<span>扫码下载澳猫APP</span>
				</div>
				<div class="fen">
	...
	<script src="<%=request.getContextPath()%>/static/js/jquery-1.7.2.min.js"></script>
